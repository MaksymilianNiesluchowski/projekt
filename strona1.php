    ...
    <body>
        <div id="container">
            ...
            <div id="content">
                ...
                $wynik = $conn-> query("SELECT * from zagadnienia_cs");
                if($wynik->num_rows > 0){
                ...
                $conn->close();
                ?>
                <p><a href='cs1.php'>Czytaj więcej o temacie 1</a></p>
                <p><a href='cs2.php'>Czytaj więcej o temacie 2</a></p>
                <p><a href='cs3.php'>Czytaj więcej o temacie 3</a></p>
